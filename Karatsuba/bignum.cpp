...
// NO ES LA DIVISION entre right y s, es: right/(10^s)
...
//No es el RESTO, es el complemento del anterior: right%(10^s)
...
bignum truelen(const bignum& right){
  ...
  if(i==right.len){
    //corto al recorrer todo right, entonces rights=0
    res.signo=right.signo;
    return res;
  }
  else if(i==0){
